...
export function OfferListPage(props: OfferListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('freight_broker', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'freight_broker',
          header: 'Freight Broker',
          accessorKey: 'freight_broker',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/freight-brokers/view/${record.freight_broker?.id}`}
            >
              {record.freight_broker?.name}
            </Link>
          ),
        }
      : null,
